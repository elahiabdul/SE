...
$db = getDbInstance();
$select = array('id', 'PMM', 'IST','FanFailure', 'created_at', 'updated_at');

//Start building query according to input parameters.
// If search string
if ($search_string) {
	$db->where('PMM', '%' . $search_string . '%', 'like');
	$db->orwhere('IST', '%' . $search_string . '%', 'like');
}
...
?>>Desc</option>
    ...
    <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                <th width="5%">ID</th>
                <th width="25%">PMM Rating</th>
                <th width="25%">Isolation Transformer</th>
                <th width="25%">Fan Failure</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo xss_clean($row['PMM']); ?></td>
                <td><?php echo xss_clean($row['IST']); ?></td>
                <td><?php echo xss_clean($row['FanFailure']); ?></td>
                <td>
