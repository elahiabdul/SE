<fieldset>
    <div class="form-group">
        <label for="f_name">First Namef *</label>
          <input type="text" name="f_name" value="<?php echo htmlsecialchars($edit ? $customer['f_name'] : '', ENT_QUOTES, 'UTF-8'); ?>" placeholder="First Name" class="form-control" required="required" id = "f_name" >
    </div> 
